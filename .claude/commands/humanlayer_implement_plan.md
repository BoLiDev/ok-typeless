...
- Read any referenced requirements/specs and all files mentioned in the plan
...
- Run the success criteria checks listed in the plan's "Automated Verification" section
